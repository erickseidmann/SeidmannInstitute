       ...
       <form id="form" class="container " action="processar_formulario.php" method="post">
          ...
          <div class="row input-group col-md-6 fw-semibold ">
              ...
              <div class="col-md-6 ">
                ...
                <input type="text" id="nome_responsavel" class="form-control bg-light" name="nome_responsavel" ><br>
              </div>
          </div>
        ...
        <p></p>
           ...
           <p></p>
              ...
              <div class="col-md-6 ">
               ...
               <input type="text" name="complemento" class="form-control bg-light" id="complemento"
          ...
          <p></p>
          <h5 class="lh-base p-3 mb-2 bg-light text-dark">Dia do pagamento: Todos os pagamentos devem ser realizados até o dia acordado pelo aluno e o professor, caso caia em fim de semana ou feriado, devera ser feito no próximo dia.
          ...
          <p></p>
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="termos_condicoes">Entendo e concordo.</label><br>
            </div>
            <br>
...
Além disso, ressaltamos que o cancelamento do curso deve ser comunicado com pelo menos uma semana de antecedência em relação à data de pagamento mensal. Caso o cancelamento ocorra fora desse prazo, será aplicada uma taxa referente a uma semana de aulas.</h5>
          ...
          <h3 class="text-center">Férias / Feriados:</h3>
            <h5 class="lh-base p-3 mb-2 bg-light text-dark">Férias: A escola não faz ajustes nos valores para os meses de 5 semanas, mas para ajustar o banco de horas, a escola tem duas férias no ano, sendo a última semana do mês de julho e a última semana de dezembro e a primeira de janeiro. Totalizando 3 semanas e dois dias de férias por ano. Qualquer dúvida favor comunicar-se com o professor responsável.
            A escola não trabalha nos feriados nacionais, as únicas aulas que podem ser remanejadas são as aulas de 1 vez por semana.</h5>
              <br>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" id="ferias" name="ferias[]" value="sim" required>
            <label class="form-check-label" for="ferias">Entendo e concordo sobre as férias e os feriados.</label><br>
            <br>
          </div>   
          <br>
          ...
          <div class="form-check">
          <input  class="form-check-input" type="checkbox" id="material" name="material[]" value="sim" required>
          <label class="form-check-label" for="material">Li e entendo sobre o Material EPBL.</label><br>
          <br>
          </div>
        ...
        <br>
          ...
          <select class="form-select bg-light" id="frequencia_aulas" name="frequencia_aulas" required>
            ...
            <option value="30min_1x">1x de 30 min</option>
            <option value="30min_2x">2x de 30 min</option>
            <option value="30min_3x">3x de 30 min</option>
            <option value="30min_4x">4x de 30 min</option>
            <option value="30min_5x">5x de 30 min</option>
            <option value="aulas_1h">Aulas de 1 hora</option>
          </div>
          </select><br>
