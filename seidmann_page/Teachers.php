...
<meta charset="UTF-8">
  ...
  .login-container {
    ...
    text-align: center;
    margin-bottom: 40px; /* Adiciona uma margem inferior para afastar o formulário do rodapé */
  }

  .login-container img {
    width: 200px;
    height: auto;
    margin-bottom: 20px; /* Adiciona uma margem inferior para afastar a imagem do formulário */
    display: block; /* Ajusta a imagem como um bloco para centralizá-la */
...
<section name="senha" data-bs-version="5.1" class="info3 cid-t6ReLS5mVc" id="info3-m">
